<?php
// source: C:\xampp\htdocs\PhpProject1\app/config/config.neon 
// source: C:\xampp\htdocs\PhpProject1\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\model\\kosikmanager' => array('22_App_Model_KosikManager'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\xampp\\htdocs\\PhpProject1\\app',
			'wwwDir' => 'C:\\xampp\\htdocs\\PhpProject1\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\xampp\\htdocs\\PhpProject1\\app/../temp',
		));
	}


	/**
	 * @return App\Model\KosikManager
	 */
	public function createService__22_App_Model_KosikManager()
	{
		$service = new App\Model\KosikManager($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\xampp\\htdocs\\PhpProject1\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=vlada', 'root', NULL, array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\xampp\\htdocs\\PhpProject1\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\xampp\\htdocs\\PhpProject1\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\xampp\\htdocs\\PhpProject1\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\xampp\\htdocs\\PhpProject1\\app/../temp/cache', $this->getService('nette.cacheJournal'));
