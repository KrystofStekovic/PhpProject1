...
list($_b, $_g, $_l) = $template->initialize('2600289025', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbecdb2be33a_content')) { function _lbecdb2be33a_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
